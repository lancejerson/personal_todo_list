...
function NewListButton({ onclick }: Props) {
    return (
        <button className="h-full aspect-square border-2 border-dashed group border-gray-600 rounded-xl flex items-center justify-center hover:border-purple-400" onClick={() => onclick?.()}>
